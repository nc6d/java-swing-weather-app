...
public class ForecastWeatherDialog extends javax.swing.JDialog {
    ...
    public ForecastWeatherDialog(java.awt.Frame parent, boolean modal, JsonObject forecastSelectedCity) {
        ...
        dateList.addListSelectionListener(lse -> {
            WeatherDetailPanel p = new WeatherDetailPanel(forecastSelectedCity
                    .getJsonArray("list")
                    .getJsonObject(getIdxDate()),
                    forecastSelectedCity
                            .getJsonObject("city")
                            .getString("name"));
    ...
    public int getIdxDate() {
        for (int i = 0; i < forecastSelectedCity.getJsonArray("list").size(); i++) {
            if (forecastSelectedCity
                    .getJsonArray("list")
                    .getJsonObject(i).getString("dt_txt")
                    .equals(dateList.getSelectedValue())) {
                return i;
            }
        }
        return 0;
    ...
    private void initPanel() {
        ...
        weatherDetailPanel = new WeatherDetailPanel(forecastSelectedCity
                .getJsonArray("list")
                .getJsonObject(getIdxDate()),
                forecastSelectedCity
                        .getJsonObject("city")
